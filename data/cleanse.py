...
Train_Crop_Dir = './data/mango/train'
Dev_Crop_Dir = './data/mango/validation'

df_train = pd.read_csv('./data/train.csv', header=None, low_memory=False)
df_dev = pd.read_csv('./data/dev.csv', header=None, low_memory=False)
#df_train.head()
#df_dev.head()
